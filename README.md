...
This script is for [Mikrotik](https://mikrotik.com/) RouterOS v7 routers. It updates Cloudflare DNS records whenever there’s a change in the router’s public IP address.
...
At the top of the script, there is a vector definition (`ParamVect`) where you can define if you want
to update a single Dns Record or multiple ones by populating one or more stanzas.
...
2. Remember to add a Scheduler that starts the script every 5 minutes, or any interval that suits your needs.<br />
<br /><br />
...
AuthToken="_Cloudflare_Auth_Key_Token_"
DnsZoneID="_Cloudflare_Dns_Zone_ID_"
